...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2021 at 07:52 AM
...
CREATE TABLE `fine` (
  ...
  `charged_fine` int(10) NOT NULL,
  `pay_fine` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(19, 6541, 'Data structure', 'M D Guptaa', 8, 1, '2121-07-03'),
(20, 6541, 'data science', 'M D Guptaa', 9, 1, '2121-07-04');
...
(8, 'Asit', '200301120041@cutm.ac.in', '1234', 2147483647, 're'),
(9, 'kartik', 'kumarkartik24@gmail.com', '1234', 2147483647, '7;lksalxlm ,');
